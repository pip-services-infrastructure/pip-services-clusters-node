...
class ClustersCommandSet extends pip_services_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetClustersCommand() {
        return new pip_services_commons_node_2.Command("get_clusters", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeGetClusterByIdCommand() {
        return new pip_services_commons_node_2.Command("get_cluster_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('cluster_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateClusterCommand() {
        return new pip_services_commons_node_2.Command("create_cluster", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateClusterCommand() {
        return new pip_services_commons_node_2.Command("update_cluster", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('cluster', new ClusterV1Schema_1.ClusterV1Schema()), (correlationId, args, callback) => {
            let cluster = args.get("cluster");
    ...
    makeDeleteClusterByIdCommand() {
        return new pip_services_commons_node_2.Command("delete_cluster_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('cluster_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeAddTenantCommand() {
        return new pip_services_commons_node_2.Command("add_tenant", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('tenant_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeRemoveTenantCommand() {
        return new pip_services_commons_node_2.Command("remove_tenant", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('tenant_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let tenantId = args.getAsNullableString("tenant_id");
