...
class ClustersServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
ClustersServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "factory", "default", "default", "1.0");
ClustersServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "persistence", "memory", "*", "1.0");
ClustersServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "persistence", "file", "*", "1.0");
ClustersServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "persistence", "mongodb", "*", "1.0");
ClustersServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "controller", "default", "*", "1.0");
ClustersServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-clusters", "service", "http", "*", "1.0");
